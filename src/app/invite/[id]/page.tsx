...
export async function generateMetadata({ params }: InvitePageProps): Promise<Metadata> {
  ...
  return {
    ...
    other: {
      'apple-itunes-app': 'app-id=6743532834, app-argument=shoply://invite/' + id,
    },
  };
}
...
export default async function InvitePage({ params }: InvitePageProps) {
  const { id } = await params;
  const deepLink = `shoply://invite/${id}`;
    ...
    <main className="min-h-screen bg-gradient-to-b from-[#0a0a0a] to-[#1a1a2e] flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center space-y-8">
        ...
        <div className="flex justify-center">
          <div className="w-24 h-24 bg-gradient-to-br from-purple-400 to-purple-600 rounded-3xl flex items-center justify-center shadow-2xl shadow-purple-500/20">
        ...
        <a
          href={deepLink}
          className="block w-full py-4 px-6 bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-purple-500/25 hover:shadow-purple-500/40"
        >
          Accept Invitation
        </a>
