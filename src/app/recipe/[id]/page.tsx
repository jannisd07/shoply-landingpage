...
export async function generateMetadata({ params }: RecipePageProps): Promise<Metadata> {
  ...
  return {
    title: 'Recipe on Shoply',
    description: 'View this delicious recipe in the Shoply app. Download Shoply to discover 10,000+ recipes and create smart shopping lists.',
    openGraph: {
      title: '🍳 Recipe on Shoply',
      description: 'View this delicious recipe in the Shoply app. Download Shoply to discover 10,000+ recipes and create smart shopping lists.',
      url: `https://shoplyai.app/recipe/${id}`,
      siteName: 'Shoply',
      type: 'website',
    },
    twitter: {
      ...
      title: '🍳 Recipe on Shoply',
      description: 'View this delicious recipe in the Shoply app.',
    },
    other: {
      'apple-itunes-app': 'app-id=6743532834, app-argument=shoply://recipe/' + id,
    },
  };
}
...
export default async function RecipePage({ params }: RecipePageProps) {
  const { id } = await params;
  const deepLink = `shoply://recipe/${id}`;
      ...
      <div className="max-w-md w-full text-center space-y-8">
        ...
        <div className="space-y-3">
          <h1 className="text-3xl font-bold text-white">
            View this Recipe in Shoply
          </h1>
          <p className="text-gray-400 text-lg">
            This recipe is waiting for you in the Shoply app. Open it to see ingredients, instructions, and add items to your shopping list.
          </p>
        </div>
